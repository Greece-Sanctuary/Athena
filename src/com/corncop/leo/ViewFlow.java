...
//			Log.d("onInterceptTouchEvent:", "X:" + xDiff + ",Y:" + yDiff);
			boolean xMoved = xDiff > mTouchSlop;

			if (xMoved && (xDiff >= 0.5*yDiff)) {
...
//			Log.d("onTouchEvent:", "X:" + xDiff + ",Y:" + yDiff);
	...
	public void setSelection(int position) {
		...
		if (mIndicator != null) {
			((ViewSwitchListener) mIndicator).onSwitched(mLoadedViews.get(mCurrentBufferIndex),
